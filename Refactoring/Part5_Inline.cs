...
/*
    We could have finished our work in the previous step, but sometimes we might find it more clear
    to inline all the checks in one method rather than delegating it to sub methods for every document
    type. When picking one solution over another is a matter of readability and personal taste. Here is
    a variant that has all the checks inlined in the IsValidDocument.
*/
[TestClass]
public class Part5
{
